...
export interface MarketRow {
  ...
  leaders: string[];                     // first 5 hosts of the latest ok|partial snapshot, platforms/ignored hosts skipped
  leadersAll: string[];                  // the same with platforms included — shown when "Show platforms" is on
